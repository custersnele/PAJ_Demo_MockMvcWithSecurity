...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	public InMemoryUserDetailsManager inMemoryUserDetailsManager() {
		...
		userDetailsList.add(User.withUsername("employee").password(encoder.encode("password"))
				.roles("EMPLOYEE", "USER").build());
		userDetailsList.add(User.withUsername("manager").password(encoder.encode("password"))
